...
<center>
<img src="https://cdn.leslie.dev/reactfolio.jpg" alt="Reactfolio" />
</center>

Live demo here: <a href="https://reactfolio.leslie.dev/" target="_blank">leslie.dev</a>
    ...
    const SEO = [
    	{
    		...
    		keywords: ["Leslie", "Leslie A", "Leslie Ajayi"],
    	},
    ];
    ```
